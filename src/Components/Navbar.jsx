...
const Navbar = () => {
  return (
    <div className="fixed z-[999] w-full px-20 pl-12 pt-5 flex justify-between items-center">
      <a href="index.html">
        <div className="logo">
          <svg
            width="72"
      ...
      <div className="links flex gap-8 font-['primary']">
        {["Services", "Our work", "About us", "Insights", "Contact us"].map(
          (item, index) => (
            <a
              key={index}
              className={`underline-animation vtext-[17px] font-medium cursor-pointer hover:-translate-y-1 ease-in-out duration-200 ${
                index === 4 && "ml-48"
              }`}
            >
              {item}
